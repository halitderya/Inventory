...
namespace WindowsFormsApplication1
{
    public partial class anasayfa : Form
    {
        ...
        private void grafiksorgulari()
        {
            ...
            SqlCommand sahipli = new SqlCommand("select  count (distinct ENVTABLO.BARKOD) from ENVTABLO inner join sahiplik on ENVTABLO.BARKOD=sahiplik.BARKOD", conn);
            ...
            SqlDataAdapter sahda= new SqlDataAdapter("select  count (distinct ENVTABLO.BARKOD) from ENVTABLO inner join sahiplik on ENVTABLO.BARKOD=sahiplik.BARKOD", conn);
        ...
        {
           WindowsFormsApplication1.Formlar.cesitli.password_reset prs = new WindowsFormsApplication1.Formlar.cesitli.password_reset();
            prs.Show();
        ...
        {
            kayitguncelle kaygun = new kayitguncelle();
            kaygun.Show();
        }
        ...
        {
            seriara pers = new seriara();
            pers.passvalue = label1.Text;
            pers.Show();
