...
{
    public partial class sahipsiz : Form
    {
        public sahipsiz()
        {
            InitializeComponent();
        ...
        private void sahipsiz_Load(object sender, EventArgs e)
        {
            ...
            //while (dr.Read())
            //    comboBox1.Items.Add(dr["DEPARTMAN"]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Markabul = new SqlCommand("SELECT env.[BARKOD],[ÜRÜN TİPİ],Marka,[Model / Sürüm],[Seri No],HDD,HDD2,İşlemci,RAM, [İşletim Sistemi],office FROM  ENVTABLO env OUTER APPLY (SELECT TOP 1 * FROM sahiplik sah where   env.BARKOD = sah.BARKOD ORDER BY sah.zimmet_tarihi DESC  ) sah  OUTER APPLY (SELECT * FROM PERSONEL per  where  sah.TAMADI=per.TAMAD) per where TAMADI IS NULL OR TAMADI='BOŞTA' OR TAMADI='DEPO' ", baglan);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "sahipsiz_varliklar.xls";
