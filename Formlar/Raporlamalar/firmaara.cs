...
namespace WindowsFormsApplication1
{
    public partial class firmaara : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Markabul = new SqlCommand("SELECT  env.[BARKOD],[ÜRÜN TİPİ],Marka,[Model / Sürüm],[Seri No],HDD,HDD2,İşlemci,RAM, [İşletim Sistemi],office,TAMAD,zimmet_tarihi,FIRMA FROM  ENVTABLO env OUTER APPLY (SELECT TOP 1 * FROM sahiplik sah where   env.BARKOD = sah.BARKOD ORDER BY sah.zimmet_tarihi DESC  ) sah  OUTER APPLY (SELECT * FROM PERSONEL per  where  per.TAMAD=SAH.TAMADI) per where per.FIRMA=('" + comboBox1.Text + "')", baglan);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = comboBox1.Text+"_firmasina_kayitli_urunler.xls";
