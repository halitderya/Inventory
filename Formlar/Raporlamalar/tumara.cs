...
{
    public partial class tumara : Form
    {
        public tumara()
        {
            InitializeComponent();
        ...
        private void tumara_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Markabul = new SqlCommand("SELECT  env.[BARKOD],[ÜRÜN TİPİ],Marka,[Model / Sürüm],[Seri No],HDD,HDD2,İşlemci,RAM, [İşletim Sistemi],office,TAMAD,zimmet_tarihi,DEPARTMAN,it,FIRMA,aciklama FROM  ENVTABLO env OUTER APPLY (SELECT TOP 1 * FROM sahiplik sah where   env.BARKOD = sah.BARKOD ORDER BY sah.zimmet_tarihi DESC  ) sah  OUTER APPLY (SELECT * FROM PERSONEL per  where  per.TAMAD=SAH.TAMADI) per order by BARKOD asc ", baglan);
